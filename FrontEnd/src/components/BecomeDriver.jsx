            ...
            <div className="driver-modal" >
                <div className="driver-modal-content">
                    <div className="driver-left">
                        <img src={Driver} alt="Become a Driver" className="driver-circle-image" />
                    </div>

                    <div className="driver-right">
                        <h2 className="driver-title" style={{ position: 'relative', top: '20px', fontSize: '28px' }}>Become a Driver</h2>
                    </div>
                </div>
                <br />
                <br />
                ...
                <div className="driver-form-row">
                    <div className="driver-form-group" >
                        <label style={{ marginRight: '220px' }}>Vehicle Type</label>
                        <select className="driver-input" style={{
                            appearance: 'none',
                            WebkitAppearance: 'none',
                            MozAppearance: 'none',
                ...
                <div className="driver-form-row">
                    ...
                    <div className="driver-form-group">
                        <label style={{ marginRight: '220px' }}> Delivery Zone</label>
                        <select className="driver-input" style={{
                            appearance: 'none',
                            WebkitAppearance: 'none',
                            MozAppearance: 'none',
                            ...
                            <option value="">Choose Here</option>
                            <option value="Zone 1 - City Center">Zone 1 - City Center</option>
                            ...
                            <option value="Zone 6 - Suburbs">Zone 6 - Suburbs</option>
